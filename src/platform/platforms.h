...
#define PLATFORMS_H
   ...
   (defined(__APPLE__) && defined(__MACH__)) || \
    ...
    defined(sun) || defined(__sun) || defined (sinux) || defined(__minix) || defined(__posix)
...
#elif defined(_WIN32) || defined(__WIN32__) || defined(_WIN64) || defined(__TOS_WIN__) || defined(__WINDOWS__) || defined(__NT__) || \
